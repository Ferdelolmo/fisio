...
import { ItalianFlag, UKFlag } from "@/components/ui/flags";
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            >
              ...
              {language === 'it' ? (
                <ItalianFlag className="h-3 w-5 shadow-sm" />
              ) : (
                <UKFlag className="h-3 w-5 shadow-sm" />
              )}
            </button>
          </div>
          ...
          <div className="md:hidden flex items-center gap-4">
            ...
            >
              ...
              {language === 'it' ? (
                <ItalianFlag className="h-4 w-6 shadow-sm" />
              ) : (
                <UKFlag className="h-4 w-6 shadow-sm" />
              )}
            </button>
